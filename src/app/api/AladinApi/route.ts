...
export async function GET(request: NextRequest) {
  ...
  if (queryType === 'ItemEditorChoice') {
    ...
    API_URL = `http://www.aladin.co.kr/ttb/api/ItemList.aspx?ttbkey=${process.env.NEXT_PUBLIC_ALADIN_TTB_KEY}&QueryType=${queryType}&SearchTarget=Book&Start=${page}&MaxResults=20&CategoryId=${categoryId}&Cover=Big&Output=js&Version=20131101`;
  }
