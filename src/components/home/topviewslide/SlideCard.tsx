    ...
    <div className="relative w-full shrink-0 h-full overflow-hidden rounded-2xl">
      ...
      <div className="relative grid grid-cols-[50%_1fr] lg:grid-cols-[42%_1fr] gap-3 sm:gap-5 lg:gap-8 p-4 sm:p-6 h-full items-center">
        ...
        <div className="flex flex-col justify-center gap-2 sm:gap-3 min-w-0">
          ...
          <BookStats viewCount={book.view_count} commentCount={book.comment_count} size="lg" />
          <Link
          ...
          >
            <span className="inline-flex items-center gap-1 rounded-full bg-[#af5858] text-white px-3 py-1 sm:px-4 sm:py-2 text-[11px] sm:text-sm font-medium shadow-sm hover:bg-[#8f4646] transition group">
              자세히 보기
              <ArrowRight className="w-4- h-4 transition-transform duration-200 translate-x-0 group-hover:translate-x-1" />
            </span>
          </Link>
        </div>
      </div>
